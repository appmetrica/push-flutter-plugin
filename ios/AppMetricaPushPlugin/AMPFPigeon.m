...
void AMPFAppMetricaPushPigeonSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<AMPFAppMetricaPushPigeon> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AppMetricaPushPigeon.activate"
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AppMetricaPushPigeon.saveAppMetricaConfig"
        binaryMessenger:binaryMessenger
        codec:AMPFAppMetricaPushPigeonGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AppMetricaPushPigeon.getTokens"
        binaryMessenger:binaryMessenger
        codec:AMPFAppMetricaPushPigeonGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AppMetricaPushPigeon.requestPermission"
        binaryMessenger:binaryMessenger
        codec:AMPFAppMetricaPushPigeonGetCodec()];
    if (api) {
...
- (void)onTokenUpdatedNewTokens:(NSDictionary<NSString *, NSString *> *)arg_newTokens completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.TokenUpdateApi.onTokenUpdated"
